          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-yappy-grey-light">
              {[
                ...
                { name: "West Coast Ports", imp: "4,800", impDelta: "-5.5%", views: "1,200", viewsDelta: "-5.1%", rate: "25.0%", rateDelta: "-0.8%", time: "16h", badges: [], trend: -1 },
                ...
                { name: "Northern Grid Services", imp: "3,100", impDelta: "-5.5%", views: "780", viewsDelta: "-5.1%", rate: "25.1%", rateDelta: "-0.6%", time: "10h", badges: [], trend: -1 },
                ...
                { name: "Urban Transit Solutions", imp: "2,800", impDelta: "-7.0%", views: "680", viewsDelta: "-7.8%", rate: "24.2%", rateDelta: "-0.7%", time: "9h", badges: [], trend: -1 },
                { name: "Prairie Railway Systems", imp: "2,600", impDelta: "+16.9%", views: "640", viewsDelta: "+17.4%", rate: "24.6%", rateDelta: "+1.1%", time: "8.5h", badges: [], trend: 1 },
                { name: "Coastal Port Authority", imp: "2,450", impDelta: "+1.7%", views: "600", viewsDelta: "+2.0%", rate: "24.4%", rateDelta: "+0.3%", time: "8h", badges: [], trend: 0 },
                { name: "Regional Distribution", imp: "2,300", impDelta: "-5.9%", views: "560", viewsDelta: "-6.3%", rate: "24.3%", rateDelta: "-0.5%", time: "7.5h", badges: [], trend: -1 },
                { name: "Frontier Logistics Hub", imp: "2,150", impDelta: "+3.8%", views: "520", viewsDelta: "+4.4%", rate: "24.1%", rateDelta: "+0.2%", time: "7h", badges: [], trend: 0 },
                { name: "Interstate Carriers", imp: "2,000", impDelta: "+19.0%", views: "480", viewsDelta: "+21.5%", rate: "24.0%", rateDelta: "+0.9%", time: "6.5h", badges: [], trend: 1 },
                { name: "Valley Transport Group", imp: "1,850", impDelta: "+3.8%", views: "440", viewsDelta: "+4.3%", rate: "23.7%", rateDelta: "+0.2%", time: "6h", badges: [], trend: 0 },
                { name: "Summit Shipping Co.", imp: "1,700", impDelta: "+20.1%", views: "410", viewsDelta: "+23.4%", rate: "24.1%", rateDelta: "+1.0%", time: "5.5h", badges: [], trend: 1 },
                { name: "Horizon Logistics Ltd.", imp: "1,550", impDelta: "-5.8%", views: "370", viewsDelta: "-6.3%", rate: "23.8%", rateDelta: "-0.4%", time: "5h", badges: [], trend: -1 },
              ].map((row, i) => {
